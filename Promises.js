...
//  Q.  Why Promises in Java-Script ?

//  Ans. Sometimes a piece of code will take (X) seconds to execute. Depending on the it, we have other piece of code.

//  --> This other piece of code is dependent on first piece of code.

//  Promise Object :-
var MyPromice = new Promise(function(resolve,reject)  //  resolve and reject are functions, Not like a variable that is a callBack function.
...
//  Earlier, we got succesfull Promise using, .then() and unsuccesfull Promise using .catch()

//  allows us to handle the values of promise.
//  .then,.catch and .
...
async function My()
{
    //  here await code write...
}

//  async is a function  |   async await is a function

//  await:-  await literally suspends the function execution until the Promise settels, and then resumes it with the Promise result.


//  Promises have Consequences :
//  1. They will be (Fullfilled)
//  2. They will not be (Fullfilled/Rejected)
//  3. The will be in the (Process/Pending)

//  Promise by nature, takes time to fullfill or not fullfill. (Basically, we have to WAIT.)
